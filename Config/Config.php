...
namespace Lof\NextGenImages\Config;
...
class Config implements ArgumentInterface
{
    ...
    {
        return (bool)$this->scopeConfig->getValue('lof_nextgenimages/settings/enabled');
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue('lof_nextgenimages/settings/convert_on_save');
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue('lof_nextgenimages/settings/lazy_loading');
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue('lof_nextgenimages/settings/debug');
    }
